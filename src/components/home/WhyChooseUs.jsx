            ...
            <div className="container-wrapper">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div
                        ...
                        className="relative h-[500px] w-full max-w-lg mx-auto lg:max-w-none"
                    >
                        ...
                        {/* Image 1 (Back/Top) */}
                        <div className="absolute top-0 right-10 w-64 h-80 rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white z-10">
                            <img
                        ...
                        <div className="absolute bottom-0 left-4 w-72 h-80 rounded-t-full rounded-b-[2rem] overflow-hidden shadow-2xl border-4 border-white z-20">
                            <img
                    ...
                    <div className="relative">
                        ...
                        <div className="space-y-12">
                            {steps.map((step, index) => (
                                ...
                                >
                                    {/* Number Circle */}
                                    <div className="relative z-10 flex-shrink-0 w-14 h-14 rounded-full border-2 border-primary/20 bg-white flex items-center justify-center shadow-sm">
                                    ...
                                    {/* Content */}
                                    <div className="pt-2">
                                        <h3 className="text-primary text-xl font-bold mb-3">{step.title}</h3>
